...
class controllers:
    ...
    omega = 0.5
    phase = 0
    pred_base = {0:4.7, 1:2.6, 2:2.1, 3:1.98}
    pred1 = []
    Rd = 0.0
    R = 0.0
    lamb = 0.07
    ...
    count_J1 = 0
    count_J2 = 0
    SavefileJ = open("/home/nvidia/Desktop/catkin_ws/src/robot_formation/LS02A/data/OD13/tuneJ.txt", "a+")
    SavefileRd = open("/home/nvidia/Desktop/catkin_ws/src/robot_formation/LS02A/data/OD13/tuneRd.txt", "a+")
    SavefileT = open("/home/nvidia/Desktop/catkin_ws/src/robot_formation/LS02A/data/OD13/ESCtime.txt", "a+")
    SavefileFOV = open("/home/nvidia/Desktop/catkin_ws/src/robot_formation/LS02A/data/OD13/FOV.txt", "a+")
    Savefilecount = open("/home/nvidia/Desktop/catkin_ws/src/robot_formation/LS02A/data/OD13/count.txt", "a+")
    SavefileI = open("/home/nvidia/Desktop/catkin_ws/src/robot_formation/LS02A/data/OD13/intensity.txt", "a+")
    Savefilea = open("/home/nvidia/Desktop/catkin_ws/src/robot_formation/LS02A/data/OD13/a.txt","a+")
